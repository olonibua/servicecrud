    ...
    <div className="h-full">
      <div className="bg-[#ffffff] h-[100vh] overflow-hidden">
        ...
        <div className="movingGradient h-[180px] md:h-[250px] mx-auto rounded-2xl max-w-full ml-6 mr-6">
          ...
          <h2 className="text-[#371941f5] font-bold text-center text-[24px] md:text-[45px] mt-4 max-w-[640px] mx-auto ">
            Service Crud
          </h2>
          <p className="font-thin text-[#371941f5] text-[11px] md:text-[15px] text-center p-3 pt-1 md:p-20 md:pt-2 mx-auto">
            ...
            Experience seamless functionality with our sleek UI powered by
            React, secure routes with Node.js and Express, dynamic data handling
            using MongoDB, and a touch of modern style courtesy of Tailwind CSS.
          </p>
        </div>
        <UsedServices />
      </div>
